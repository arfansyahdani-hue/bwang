...
//
const BotName = 'Mr1299 '; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/dzul_gans'; // Nama Instagramlu cok
const whatsapplu = '0812-9883-2147'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/H00KpVq5ixLK1NqkJDSzrJ'; // OFFICIAL GRUP LU 1
const grupch2 = '--'
//
const
{
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @dzul_gans`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @dzul_gans`)
})
